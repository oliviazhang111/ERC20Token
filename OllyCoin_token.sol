...
contract OllyCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function OllyCoin() {
        ...
        name = "OllyCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "OYC";                                             // Set the symbol for display purposes (CHANGE THIS)
